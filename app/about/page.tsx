...
export default function AboutPage() {
  return (
    <section className="relative bg-gradient-to-b from-indigo-100 via-white to-indigo-50 py-28 px-8 md:px-20 overflow-hidden">
      ...
      {/* Floating background glow effects (static now) */}
      <div
        className="absolute top-10 right-16 w-44 h-44 bg-indigo-300 rounded-full blur-[100px] opacity-30"
      />
      <div
        className="absolute bottom-16 left-16 w-56 h-56 bg-indigo-200 rounded-full blur-[120px] opacity-30"
      />
